...
import resume from '../assets/Tanmay_Maity_Resume.pdf'
    ...
    <div name="home" className='w-full  h-screen bg-slate-950'>
      <div className='max-w-[1000px] mx-auto px-8  flex flex-col justify-center h-full '>
        ...
        <div className='flex gap-5 items-center'>
          ...
          <a href={resume} download={"Tanmay_Maity_Resume.pdf"} className='bg-[#87CEEB] border-2  border-[#87CEEB] text-slate-950 px-1 py-1 md:px-6 md:py-3 md:my-2 flex items-center duration-200'>
