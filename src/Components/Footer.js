      ...
      <div className='max-w-[1000px] mx-auto p-4 flex flex-col items-center w-full  md:h-full'>
        ...
        <ul className='flex gap-8 mt-3 text-3xl list-none'>
          <li className=' text-3xl'>
            <a href="https://www.linkedin.com/in/tanmay-maity/" target='_blank' rel="noreferrer"><AiFillLinkedin className='text-blue-600' />
            </a>
          </li>

          <li className='text-3xl'>
            <a href="https://github.com/tanmaymaity6" target='_blank' rel="noreferrer"><AiFillGithub /></a>
          </li>
        ...
        <p className='flex items-center mt-3'>made with <span className='text-red-600'> <AiFillHeart className='mx-1' /></span> by Tanmay</p>
